...
plot_labeled_histogram(50, data_G, 'Freed.-Diac.', x, pdf_G,
                       ax=ax[2], hide_x=True, hide_y=True)
plot_labeled_histogram(55, data_G, 'Knuth\'s Rule', x, pdf_G,
...
plot_labeled_histogram(50, data_NG, 'Freed.-Diac.', x, pdf_NG,
                       ax=ax[3], hide_x=True, hide_y=True)
plot_labeled_histogram(55, data_NG, 'Knuth\'s Rule', x, pdf_NG,
